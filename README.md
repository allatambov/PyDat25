...
* Шкалы данных и выбор способа описания данных в зависимости от шкалы ([слайды](https://disk.yandex.ru/i/S_33vJoyZVPajg))
* Практикум 1. Описание датафрейма: атрибуты и методы. Перекодирование данных ([ipynb](https://github.com/allatambov/PyDat25/blob/main/pydat-practice01.ipynb), [csv](https://github.com/allatambov/PyDat25/blob/main/disney_clean.csv)), решения ([ipynb](https://github.com/allatambov/PyDat25/blob/main/pydat-practice01-solved.ipynb))
* Практикум 1*. Категориальные данные и дискретизация данных в pandas ([ipynb](https://github.com/allatambov/PyDat25/blob/main/pydat-practice01-add.ipynb))
...
* Практикум 6. Датафреймы pandas: формат дата-время и объединение датафреймов ([ipynb](https://github.com/allatambov/PyDat25/blob/main/pydat-practice06.ipynb)), решения ([ipynb](https://github.com/allatambov/PyDat25/blob/main/pydat-practice06-solved.ipynb))

Дополнительно для желающих:

Так мы работаем с файлами, где много текста, можно познакомиться с этапами предварительной обработки
текста и построением облаков слов для визуализации наиболее и наименее частотных слов. Для этого можно
...
* Необходимая теория для выполнения работы: материалы недели 12 + [слайды](https://disk.yandex.ru/i/SNZVy5QZ3zKwRg) по критерию хи-квадрат + [конспект](https://github.com/allatambov/PyDat25/blob/main/lab07-theory.ipynb) с кодом для визуализации и оценки связей между показателями в разных шкалах
